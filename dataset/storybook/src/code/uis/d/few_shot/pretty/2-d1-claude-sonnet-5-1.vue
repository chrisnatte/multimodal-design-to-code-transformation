    ...
    <template #header>
      <div class="flex w-full items-center justify-between">
        ...
        <div class="flex items-center gap-4">
          ...
          <Button icon="pi pi-times" severity="secondary" text @click="isVisible = false" />
        </div>
      </div>
    </template>
    <Tabs value="0" :pt="{ root: '!shadow-none' }">
      <TabList>
      ...
      <TabPanels>
        <TabPanel value="0">
          <div class="flex flex-col gap-4 p-4">
            ...
            <div class="flex flex-col gap-2">
              ...
              <InputText v-model="email" type="email" input-id="email-input" placeholder="E-Mail eingeben" />
            </div>
            <div class="flex flex-col gap-2">
        ...
        <TabPanel value="1">
          <div class="p-4">Einstellungen</div>
        </TabPanel>
      </TabPanels>
    </Tabs>
    <template #footer>
