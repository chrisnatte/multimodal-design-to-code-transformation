  ...
  >
    <template #header>
      <div class="flex items-center gap-4">
        ...
        <div class="flex flex-col">
          <span class="text-sm font-medium text-slate-900">Max Mustermann</span>
          <span class="text-xs text-slate-500">Manager</span>
        </div>
        <Tag value="Aktiv" severity="success" class="ml-4" />
      </div>
    </template>
    ...
    <div class="flex flex-col gap-6">
      <div class="flex border-b border-slate-200">
        <button
          class="border-b-2 border-emerald-500 px-4 py-3 text-sm font-bold text-slate-900"
        >
          Persönliche Daten
        </button>
        <button
          class="border-b-2 border-transparent px-4 py-3 text-sm font-bold text-slate-500 hover:text-slate-700"
        >
          Einstellungen
        </button>
      </div>
