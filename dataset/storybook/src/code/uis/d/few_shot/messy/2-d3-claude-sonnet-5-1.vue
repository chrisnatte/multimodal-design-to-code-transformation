  ...
  >
    <template #header>
      <div class="flex w-full items-center justify-between">
        ...
        <Tag value="Aktiv" severity="success" class="mr-2" />
      </div>
    </template>
      ...
      <TabPanels>
        <TabPanel value="0">
          <div class="flex flex-col gap-4 p-6">
            ...
            <div class="flex flex-col gap-2">
              <label for="role-select" class="text-sm">Rolle</label>
              <Select v-model="role" :options="roleOptions" option-label="label" option-value="value" input-id="role-select" />
            </div>
            <div class="flex items-center gap-2">
        ...
        <TabPanel value="1">
          <div class="p-6">
            <span class="text-sm text-gray-500">Keine Einstellungen verfügbar.</span>
          </div>
        </TabPanel>
      </TabPanels>
    </Tabs>
