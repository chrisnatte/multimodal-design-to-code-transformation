<template>
  <div class="flex min-h-screen bg-white">
    ...
    <aside class="w-64 bg-slate-50 p-6">
      <h2 class="mb-4 text-base text-slate-800">Navigation</h2>
      <nav class="flex flex-col gap-2">
        <Button
          label="Dashboard"
          icon="pi pi-th-large"
          text
          class="w-full !justify-start !bg-emerald-100 !text-emerald-700 !border !border-emerald-300"
        />
        <Button
          label="Kunden"
          icon="pi pi-users"
        ...
        <div class="flex-1 rounded-lg bg-slate-100">
          ...
          <div class="flex gap-6 p-4">
            <div class="flex flex-col gap-2">
              ...
              <Calendar v-model="dateRange" placeholder="Zeitraum wählen" inline />
            </div>
            <div class="flex flex-col gap-2">
...
<script setup lang="ts">
  ...
  const rowMenu = useTemplateRef('row-actions-menu')
