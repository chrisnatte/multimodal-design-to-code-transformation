  ...
  >
    <template #header>
      <div class="flex items-center gap-3 w-full pr-2">
        <Avatar label="M" shape="circle" class="bg-slate-100 text-slate-700" />
        <div class="flex flex-col flex-grow">
          <span class="text-sm font-medium text-gray-900 leading-none">Max Mustermann</span>
          <span class="text-xs text-gray-500 mt-1">Manager</span>
        </div>
        ...
        <TabPanel value="0">
          <div class="flex flex-col gap-4">
            ...
            <div class="flex flex-col gap-1.5">
              ...
              <Select id="role" v-model="selectedRole" :options="roles" />
            </div>
