<template>
    <main class="min-h-screen bg-white px-4 pt-4 text-surface-900">
        <section class="flex items-start gap-4">
            <Button
                ...
                rounded
                aria-label="Zurück"
                class="mt-1 !h-[50px] !w-[50px] !bg-surface-100 !text-surface-700"
            />
        ...
        <section class="ml-[66px] mt-3">
            <Breadcrumb :home="home" :model="breadcrumbItems" aria-label="Pfadnavigation" class="w-fit !bg-white !p-3.5" />
        </section>
        ...
        <section class="ml-[66px] mt-4 flex items-start gap-4">
            <div class="flex w-[216px] flex-col gap-2">
                ...
                <span class="relative">
                    ...
                    <InputText
                        ...
                        v-model="searchTerm"
                        placeholder="Suche..."
                        class="h-[33px] w-[216px] !py-[7px] !pl-9 !pr-3 text-sm"
                    />
                </span>
            </div>
            ...
            <div class="flex w-[216px] flex-col gap-2">
                ...
                <Select
                    ...
                    :pt="{ root: { class: '!border-primary' } }"
                />
            </div>
        </section>

        <section class="ml-[66px] mt-4 w-[1472px] max-w-[calc(100vw-98px)] overflow-x-auto">
            <DataTable
                :value="tasks"
                v-model:selection="selectedTasks"
                dataKey="id"
                showGridlines
                tableStyle="min-width: 1472px"
                :pt="{
                    table: { class: 'text-sm' },
                    headerCell: { class: '!bg-white !px-3.5 !py-[10px]' },
                    bodyCell: { class: '!px-3.5 !py-[10px]' }
                }"
            >
        ...
        <Popover ref="actionsPopover" aria-label="Aufgabenaktionen">
            <div class="flex w-[177px] flex-col gap-2">
                <Button label="Bearbeiten" icon="pi pi-pencil" severity="secondary" variant="outlined" size="small" fluid />
