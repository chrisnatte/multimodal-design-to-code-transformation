<template>
  ...
  >
    <Button label="Bearbeiten" icon="pi pi-pen-to-square" severity="secondary" text class="w-full !justify-start" />
    <Button label="Duplizieren" icon="pi pi-copy" severity="secondary" text class="w-full !justify-start" />
    <Button label="Löschen" icon="pi pi-trash" severity="danger" text class="w-full !justify-start" />
  </Popover>
</template>
