  ...
  <div class="p-6">
    <DataTable :value="users" class="w-full">
      ...
      <Column field="status" header="Status">
        <template #body="slotProps">
          <Tag :value="slotProps.data.status" :severity="statusSeverity(slotProps.data.status)" rounded />
        </template>
      </Column>
      ...
      <Column header="Aktion" style="width: 80px">
        <template #body="slotProps">
    ...
    <Popover ref="op">
      <div class="flex flex-col gap-1 w-[220px]">
        <Button label="Profil bearbeiten" icon="pi pi-pencil" text class="justify-start" />
        <Button label="Status ändern" icon="pi pi-flag" text class="justify-start" />
        <Button label="Duplizieren" icon="pi pi-copy" text class="justify-start" />
        <Button label="Deaktiveren" icon="pi pi-trash" text severity="secondary" class="justify-start" />
      </div>
    </Popover>
  </div>
</template>
