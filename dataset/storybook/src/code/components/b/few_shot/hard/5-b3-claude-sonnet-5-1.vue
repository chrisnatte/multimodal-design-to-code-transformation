          ...
          <div class="flex flex-col gap-4">
            <div class="flex items-center justify-between">
              <div class="flex flex-col">
                ...
                <span class="text-xs font-light text-gray-500">Für alle Teammitglieder</span>
              </div>
            ...
            <div class="flex items-center justify-between">
              <div class="flex flex-col">
                ...
                <span class="text-xs font-light text-gray-500">Bei Statusänderungen</span>
              </div>
              <ToggleSwitch v-model="isNotified" />
            </div>
          </div>
        </TabPanel>
        <TabPanel value="1">
          <p class="m-0">Zeitplan-Inhalte hier.</p>
        </TabPanel>
        <TabPanel value="2">
          <p class="m-0">Einstellungen-Inhalte hier.</p>
        </TabPanel>
      </TabPanels>
    </Tabs>
    <template #footer>
