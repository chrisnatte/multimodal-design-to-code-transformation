<template>
  <Dialog
    ...
    :pt="{
      ...
      content: 'flex flex-col gap-4 pt-4',
    }"
  >
    ...
    <div class="flex flex-col gap-1">
      ...
      <Select id="role" v-model="role" :options="roles" placeholder="Rolle wählen" class="w-full" />
    </div>
    ...
    <template #footer>
      <Button label="Abbrechen" text plain @click="visible = false" />
      <Button label="Speichern" severity="primary" @click="visible = false" />
    </template>
  </Dialog>
</template>
