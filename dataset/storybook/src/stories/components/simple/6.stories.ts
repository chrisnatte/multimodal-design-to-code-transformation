...
import SimpleComponentFileUploadStatusMethodC1 from './6-c1.vue'
import SimpleComponentFileUploadStatusMethodC2 from './6-c2.vue'
import SimpleComponentFileUploadStatusMethodC3 from './6-c3.vue'
...
export const MethodC1 = {
  render: () => ({
    components: { SimpleComponentFileUploadStatusMethodC1 },
    template: '<SimpleComponentFileUploadStatusMethodC1 />',
  }),
}

export const MethodC2 = {
  render: () => ({
    components: { SimpleComponentFileUploadStatusMethodC2 },
    template: '<SimpleComponentFileUploadStatusMethodC2 />',
  }),
}

export const MethodC3 = {
  render: () => ({
    components: { SimpleComponentFileUploadStatusMethodC3 },
    template: '<SimpleComponentFileUploadStatusMethodC3 />',
  }),
}
