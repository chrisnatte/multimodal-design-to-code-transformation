  ...
  <div class="min-h-screen bg-black flex items-center justify-center p-4">
    ...
    >
      <Tabs v-model:value="activeTab" class="w-full">
        ...
        <TabPanels>
          <TabPanel value="0">
            <div class="flex flex-col gap-4 pt-3 pb-4 px-1">
              <div class="flex justify-between items-center px-1">
                <div class="flex flex-col">
                  <span class="font-semibold text-sm">Öffentlich sichtbar</span>
                  <span class="font-light text-[10px]">Für alle Teammitglieder</span>
                </div>
              ...
              <div class="flex justify-between items-center px-1">
                <div class="flex flex-col">
                  ...
                  <span class="font-light text-[10px]">Bei Statusänderungen</span>
                </div>
      ...
      <template #footer>
        <div class="flex justify-end gap-[7px] w-full">
          <Button 
            label="Abbrechen" 
            severity="secondary" 
            @click="visible = false" 
