...
import HardComponentAppointmentBookDialogMethodC1 from './9-c1.vue'
import HardComponentAppointmentBookDialogMethodC2 from './9-c2.vue'
import HardComponentAppointmentBookDialogMethodC3 from './9-c3.vue'
...
export const MethodC1 = {
  render: () => ({
    components: { HardComponentAppointmentBookDialogMethodC1 },
    template: '<HardComponentAppointmentBookDialogMethodC1 />',
  }),
}

export const MethodC2 = {
  render: () => ({
    components: { HardComponentAppointmentBookDialogMethodC2 },
    template: '<HardComponentAppointmentBookDialogMethodC2 />',
  }),
}

export const MethodC3 = {
  render: () => ({
    components: { HardComponentAppointmentBookDialogMethodC3 },
    template: '<HardComponentAppointmentBookDialogMethodC3 />',
  }),
}
