<template>
  <div class="flex flex-col gap-4">
    <div
      ...
      :key="notification.id"
      class="bg-white rounded-xl w-[640px]"
    >
      <!-- header -->
      <div class="flex flex-row items-center justify-between gap-2.5 p-2.5">
      ...
      <div class="flex flex-col gap-1.5 pb-4">
        ...
        <div class="flex flex-row items-center justify-end gap-2 px-4">
          ...
          <Button label="Akzeptieren" severity="primary" @click="onAccept(notification.id)" />
        </div>
      </div>
    </div>
  </div>
