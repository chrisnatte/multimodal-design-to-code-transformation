...
import MediumComponentFAQAccordionPasswordInputMethodC1 from './3-c1.vue'
import MediumComponentFAQAccordionPasswordInputMethodC2 from './3-c2.vue'
import MediumComponentFAQAccordionPasswordInputMethodC3 from './3-c3.vue'
...
export const MethodC1 = {
  render: () => ({
    components: { MediumComponentFAQAccordionPasswordInputMethodC1 },
    template: '<MediumComponentFAQAccordionPasswordInputMethodC1 />',
  }),
}

export const MethodC2 = {
  render: () => ({
    components: { MediumComponentFAQAccordionPasswordInputMethodC2 },
    template: '<MediumComponentFAQAccordionPasswordInputMethodC2 />',
  }),
}

export const MethodC3 = {
  render: () => ({
    components: { MediumComponentFAQAccordionPasswordInputMethodC3 },
    template: '<MediumComponentFAQAccordionPasswordInputMethodC3 />',
  }),
}
