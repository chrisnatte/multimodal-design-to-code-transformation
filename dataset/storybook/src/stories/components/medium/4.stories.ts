...
import MediumComponentDashboardNavigationMethodC1 from './4-c1.vue'
import MediumComponentDashboardNavigationMethodC2 from './4-c2.vue'
import MediumComponentDashboardNavigationMethodC3 from './4-c3.vue'
...
export const MethodC1 = {
  render: () => ({
    components: { MediumComponentDashboardNavigationMethodC1 },
    template: '<MediumComponentDashboardNavigationMethodC1 />',
  }),
}

export const MethodC2 = {
  render: () => ({
    components: { MediumComponentDashboardNavigationMethodC2 },
    template: '<MediumComponentDashboardNavigationMethodC2 />',
  }),
}

export const MethodC3 = {
  render: () => ({
    components: { MediumComponentDashboardNavigationMethodC3 },
    template: '<MediumComponentDashboardNavigationMethodC3 />',
  }),
}
