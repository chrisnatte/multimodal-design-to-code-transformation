...
import MediumComponentInfoCardWithProgressMethodC1 from './10-c1.vue'
import MediumComponentInfoCardWithProgressMethodC2 from './10-c2.vue'
import MediumComponentInfoCardWithProgressMethodC3 from './10-c3.vue'
...
export const MethodC1 = {
  render: () => ({
    components: { MediumComponentInfoCardWithProgressMethodC1 },
    template: '<MediumComponentInfoCardWithProgressMethodC1 />',
  }),
}

export const MethodC2 = {
  render: () => ({
    components: { MediumComponentInfoCardWithProgressMethodC2 },
    template: '<MediumComponentInfoCardWithProgressMethodC2 />',
  }),
}

export const MethodC3 = {
  render: () => ({
    components: { MediumComponentInfoCardWithProgressMethodC3 },
    template: '<MediumComponentInfoCardWithProgressMethodC3 />',
  }),
}
