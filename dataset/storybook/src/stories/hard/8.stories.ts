...
import HardComponentAdvancedProductDetailViewMethodC1 from './8-c1.vue'
import HardComponentAdvancedProductDetailViewMethodC2 from './8-c2.vue'
import HardComponentAdvancedProductDetailViewMethodC3 from './8-c3.vue'
...
export const MethodC1 = {
  render: () => ({
    components: { HardComponentAdvancedProductDetailViewMethodC1 },
    template: '<HardComponentAdvancedProductDetailViewMethodC1 />',
  }),
}

export const MethodC2 = {
  render: () => ({
    components: { HardComponentAdvancedProductDetailViewMethodC2 },
    template: '<HardComponentAdvancedProductDetailViewMethodC2 />',
  }),
}

export const MethodC3 = {
  render: () => ({
    components: { HardComponentAdvancedProductDetailViewMethodC3 },
    template: '<HardComponentAdvancedProductDetailViewMethodC3 />',
  }),
}
